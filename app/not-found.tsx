...
const NotFound = () => {
  ...
  return (
    ...
    <div className={`text-center px-4 transform transition-all duration-1000 ${animate ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
      <h2 className="text-8xl font-bold text-[#193d3d] mb-4">404</h2>
      <h3 className="text-3xl font-semibold text-[#193d3d] mb-6">Page Not Found</h3>
